        ...
        this.each(function (m) {
            ...
            switch (m.get('type')) {
                ...
                case 'item':
                    ...
                    break;
                case 'directory':
                    params[m.id + '_girderFolderId'] = m.value().id;
                    break;
                case 'new-file':
                    // window.girderFolder = m.value();
                    params[m.id + '_girderFolderId'] = m.value().get('folderId'); // get('folderId');
                ...
                case 'new-item':
                    ...
                    break;
                case 'new-directory':
                    params[m.id + '_girderFolderId'] = m.parent().id;
                    params[m.id + '_name'] = m.value();
                    break;
                case 'image':
                    params[m.id + '_girderFileId'] = m.value().id;
                    break;
